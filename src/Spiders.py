...
"""
    Spiders eh um webcrawler que pega e formata
    os dados no site do matricula web.
"""
...
class Spider(object):
    ...
    def make_request(self, link):
        ...
        if link is None:
            return None
        # 1 seg de espera pra nao fazer muitas requests muito rapido
        time.sleep(1)
        i = 0
        while True:
            try:
    ...
    def get_curriculo(self, num, verbose=False):
        """
            ...
            Retorna None em caso do codgio nao existir
        """
